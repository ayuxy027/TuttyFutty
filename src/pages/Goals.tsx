      ...
      <div className="flex-1 overflow-y-auto px-grid-3 py-grid-3">
        ...
        {goals.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-grid-4 text-center">
            <p className="font-mono text-xs text-muted-foreground">No goals yet</p>
            <p className="font-mono text-[10px] text-muted-foreground">Click + to add your first goal</p>
          </div>
        ) : (
